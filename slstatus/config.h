...
#define KANSO_BLACK		"#090E13"
#define KANSO_WHITE		"#C5C9C7"
#define KANSO_RED		"#e27878"
#define KANSO_GREEN		"#b4be82"
#define KANSO_ORANGE	"#e2a478"
#define KANSO_BLUE		"#84a0c6"
#define KANSO_MAGENTA	"#a093c7"
#define KANSO_CYAN		"#89b8c2"

static const struct arg args[] = {
    /* function format          argument */
    {wifi_essid, "^b" GRUVBOX_WHITE "^^c" GRUVBOX_BLACK "^ 󰤥 : %s ^d^ ", "wlan0"},
    {wifi_perc, "^b" GRUVBOX_RED "^^c" GRUVBOX_BLACK "^ 󰤥 : %s ^d^ ", "wlan0"},
    {run_command, "^b" GRUVBOX_ORANGE "^^c" GRUVBOX_BLACK "^ 󰕾 : %s ^d^ ",
     "amixer sget Master | tail -1 | awk '{print $4 }' | sed "
     "'s@\\(\\[\\|\\]\\)@@g'"},

    {ram_perc, "^b" GRUVBOX_GREEN "^^c" GRUVBOX_BLACK "^ 󰍛 : %s ^d^ ", NULL},
    {netspeed_rx, "^b" GRUVBOX_CYAN "^^c" GRUVBOX_BLACK "^ Speed: %s ^d^ ", "wlan0"},
